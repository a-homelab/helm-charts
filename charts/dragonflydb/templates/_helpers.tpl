...
*/}}
{{- define "dragonflydb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "dragonflydb.fullname" .) .Values.serviceAccount.name }}
{{- else }}
